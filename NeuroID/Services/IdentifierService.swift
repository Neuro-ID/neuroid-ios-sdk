...
protocol IdentifierServiceProtocol {
    ...
    func scrubIdentifier(_ identitier: String) -> String
}
...
class IdentifierService: IdentifierServiceProtocol {
    ...
    // TODO - Check if ID was set by NID, then immutable, otherwise allow change.
    ...
    internal func validateIdentifier(_ identitier: String) -> Bool {
        ...
        do {
            ...
            let result = expression.matches(
                ...
                range: NSMakeRange(0, identitier.count))
            if result.count != 1 {
