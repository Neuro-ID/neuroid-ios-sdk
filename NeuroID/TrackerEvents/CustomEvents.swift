...
public extension NeuroIDTracker {
    ...
    func captureEventRadioChange(isChecked: Bool, radioButton: UIView) {
        ...
        NeuroIDTracker.captureEvent(event: NIDEvent(type: .radioChange, tg: tg, v: String(isChecked)))
    }

    func captureEventSubmission(_ params: [String: TargetValue]? = nil) {
        NeuroIDTracker.captureEvent(event: NIDEvent(type: .formSubmit, tg: params, view: nil))
        NeuroIDTracker.captureEvent(event: NIDEvent(type: .applicationSubmit, tg: params, view: nil))
        NeuroIDTracker.captureEvent(event: NIDEvent(type: .pageSubmit, tg: params, view: nil))
    }

    func captureEventSubmissionSuccess(_ params: [String: TargetValue]? = nil) {
        NeuroIDTracker.captureEvent(event: NIDEvent(type: .formSubmitSuccess, tg: params, view: nil))
        NeuroIDTracker.captureEvent(event: NIDEvent(type: .applicationSubmitSuccess, tg: params, view: nil))
    }
    ...
    func captureEventSubmissionFailure(error: Error, params: [String: TargetValue]? = nil) {
        ...
        NeuroIDTracker.captureEvent(event: NIDEvent(type: .formSubmitFailure, tg: newParams, view: nil))
        NeuroIDTracker.captureEvent(event: NIDEvent(type: .applicationSubmitFailure, tg: newParams, view: nil))
    } 
